...
export default class Imprint extends Component {
    ...
    constructor(props) {
        ...
        this.markdown =
            `
# ${Application.applicationName ?? "sweedspot"}
...
_${Application.applicationName ?? "sweedspot"}:${Application.nativeApplicationVersion ?? ""}_
`;
...
*   **Application** means the software program provided by the Company downloaded by You on any electronic device, named sweedspot

*   **Application Store** means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.

*   **Affiliate** means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.

*   **Country** refers to: Rheinland-Pfalz, Germany

*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to sweedspot.
...
*   By visiting this page on our website: [sweedspot.eu](sweedspot.eu)
...
*   **Application** refers to sweedspot, the software program provided by the Company.
